...
} from "./chunk-G6LO7BRX.js";
import "./chunk-RKL5KKQG.js";
import {
  createLockController
} from "./chunk-WC4KHJWA.js";
...
import {
  transition
} from "./chunk-3BRAOICA.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-KRELXT4P.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-RC5HTYUZ.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-UHAXTLK2.js";
import {
  shouldUseCloseWatcher
} from "./chunk-WV5TP7V3.js";
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-CWbP1eJz-O7UFD4ON.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-7t9T91bG-BD35HAJB.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-C3lNp93k-PI2SIADU.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-DcH0BbDp-SX3ZQEV2.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-43C2KLGL.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-UBY57GP4.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-VdaUzLWy-F6MV5JJD.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-BKBX4MZB.js.map
