...
@RestController
@RequestMapping("/api/anomaly-notifications")
@CrossOrigin(origins = "*")
public class AnomalyNotificationController {

    @Autowired
    private UserAnomalyNotificationService anomalyNotificationService;

    @GetMapping("/unread")
    public ResponseEntity<List<AnomalyNotificationDTO>> getUnreadNotifications(Authentication authentication) {
        try {
            ...
            List<AnomalyNotificationDTO> notifications = anomalyNotificationService.getUnreadNotificationsForUser(username);
            return ResponseEntity.ok(notifications);
        } catch (Exception e) {
            System.err.println("Error fetching unread anomaly notifications: " + e.getMessage());
    ...
    public ResponseEntity<Map<String, String>> markAsRead(@PathVariable Long notificationId, Authentication authentication) {
        try {
            ...
            String username = authentication.getName();
            anomalyNotificationService.markNotificationAsRead(notificationId, username);
            return ResponseEntity.ok(Map.of("message", "Notification marked as read"));
        } catch (Exception e) {
            System.err.println("Error marking anomaly notification as read: " + e.getMessage());
    ...
    public ResponseEntity<Map<String, Long>> getUnreadCount(Authentication authentication) {
        try {
            ...
            String username = authentication.getName();
            long count = anomalyNotificationService.getUnreadNotificationCount(username);
