<<<<<<<< HEAD:FF-API/firefighter-platform/src/main/java/com/apex/firefighter/config/SecurityConfig.java
...
>>>>>>>> origin/develop:FF-API/src/main/java/com/apex/firefighter/config/SecurityConfig.java
} 